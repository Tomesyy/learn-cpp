...
/*
    ...
    The std::cout is a buffered i.e the requests to it are stored somewhere in the memory, before the it is being flushed.
    ...
    Best practice is to use '\n' over 'std::endl' when printing text to the console.
        - std::endl is quite inefficient because it actually does two jobs: it moves the console to the next line,
